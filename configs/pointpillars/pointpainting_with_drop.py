...
custom_imports = dict(imports=['my_transforms'], allow_failed_imports=False)
...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'kitti_1225_dbinfos_train_painted.pkl', 
    rate=1.0,
    prepare=dict(
...
train_pipeline = [
    ...
    dict(type='RandomDropPaintedFeatures', drop_prob=0.2, painted_dims=4),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type='KittiDataset',
            data_root=data_root,
            ann_file='kitti_1225_infos_train.pkl',
